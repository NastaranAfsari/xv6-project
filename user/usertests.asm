...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4ef4:	00003797          	auipc	a5,0x3
    4ef8:	55c7b783          	ld	a5,1372(a5) # 8450 <freep>
    ...
    4f20:	00e6ea63          	bltu	a3,a4,4f34 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    4f5e:	00003717          	auipc	a4,0x3
    4f62:	4ef73923          	sd	a5,1266(a4) # 8450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    4f8c:	4c853503          	ld	a0,1224(a0) # 8450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    4fb8:	00003917          	auipc	s2,0x3
    4fbc:	49890913          	addi	s2,s2,1176 # 8450 <freep>
  if(p == (char*)-1)
    4fc0:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    4fcc:	0000a797          	auipc	a5,0xa
    4fd0:	cac78793          	addi	a5,a5,-852 # ec78 <base>
    4fd4:	00003717          	auipc	a4,0x3
    4fd8:	46f73e23          	sd	a5,1148(a4) # 8450 <freep>
  ...
  if(p == (char*)-1)
    ...
    503e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5042:	00003717          	auipc	a4,0x3
    5046:	40a73723          	sd	a0,1038(a4) # 8450 <freep>
      return (void*)(p + 1);
